...
<section class="content">
  <div class="box">
    <div class="box-header with-border">
      <h4 class="box-title text-capitalize">Data vendor</h4>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="data-form" class="pl-3 pr-3">
          <?= csrf_field() ?>
          <div class="row">
            <input type="hidden" id="id_vendor" name="id_vendor" class="form-control" placeholder="Id vendor" required>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group mb-3">
                <label for="vendor_name" class="col-form-label"> Vendor name: <span class="text-danger">*</span> </label>
                <input type="text" id="vendor_name" name="vendor_name" class="form-control" placeholder="Vendor name" minlength="0" maxlength="100" required>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group mb-3">
...
<script>
  ...
  function save(id_vendor) {
    // reset the form 
    $("#data-form")[0].reset();
    $(".form-control").removeClass('is-invalid').removeClass('is-valid');
    if (typeof id_vendor === 'undefined' || id_vendor < 1) { //add
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          $('#data-modal').modal('show');
          //insert data to form
          $("#data-form #id_vendor").val(response.id_vendor);
          $("#data-form #vendor_name").val(response.vendor_name);
